...
# ggsave(
#   filename = here::here("manuscript/img/fig_1.tiff"),
...
# ggsave(
#   filename = here::here("manuscript/img/fig_2.tiff"),
#   plot = roc_curve,
#   device = "tiff",
#   dpi = 600
#   )
...
The authors further thank the developers of the following R packages used to process, analyze, display and report data: `r cite_r(file = "bib/r-references.bib")`.
