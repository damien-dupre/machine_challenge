...
```{r results="asis"}
accuracy_score %>% 
  dplyr::filter(Expressions == "Spontaneous\nExpressions") %>%
  dplyr::select(-Classifier, -Expressions) %>% 
  knitr::kable(
    format = "latex",
    caption = "S6 Table. Performance indices for human observers and automatic classifiers by emotion in the context of spontaneous expressions.",
    booktabs = TRUE,
    digits = 2,
    linesep = "",
    escape = FALSE,
